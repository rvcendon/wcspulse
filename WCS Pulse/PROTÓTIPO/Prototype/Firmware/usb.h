...
#include "c:/Microchip Solutions v2010-10-19/Microchip/Include/Compiler.h"

#include "usb_config.h"             // Must be defined by the application

#include "c:/Microchip Solutions v2010-10-19/Microchip/Include/usb/usb_common.h"         // Common USB library definitions
#include "c:/Microchip Solutions v2010-10-19/Microchip/Include/usb/usb_ch9.h"            // USB device framework definitions

#if defined( USB_SUPPORT_DEVICE )
    #include "c:/Microchip Solutions v2010-10-19/Microchip/Include/usb/usb_device.h"     // USB Device abstraction layer interface
#endif
...
#include "c:/Microchip Solutions v2010-10-19/Microchip/Include/usb/usb_hal.h"            // Hardware Abstraction Layer interface
