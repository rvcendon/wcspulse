...
namespace WCS_Pulse
{
    public partial class frmMonitor : Form
    {
        ...
        public frmMonitor()
        {
            ...
            System.Drawing.Bitmap Img = new System.Drawing.Bitmap("C:\\Users\\rodrigo\\Desktop\\SW\\WCS_Pulse\\WCS_Pulse\\Resources\\monitor_bg.bmp");
        ...
        private void tmrUSB_Tick(object sender, EventArgs e)
        {
            ...
            if (serialPort1.ReadBufferSize > 3)
            {
                    ...
                    if (buffer[i] == 0xAA)
                        if (buffer[i + 1] == 0xFF)
                        {
                            if ((fc > 30) && (fc < 240))
                            {
                                ...
                                fc = buffer[i + 2];
                                txtRR.Text += (1 / (fc / 60)).ToString("0.000").Replace(".", ",") + ",\r\n";
                            }
                        }
                }
            }
